...
const EmailVerificationTemplate = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      <section className="bg-white mx-auto max-w-2xl">
        ...
        <div className="flex h-[200px] w-full flex-col items-center justify-center gap-5 bg-primary text-light-text">
          <div className="flex items-center gap-3">
            <div className="bg-white h-[1px] w-10"></div>
            <EmailIcon />
            <div className="bg-white h-[1px] w-10"></div>
          </div>
        ...
        <main className="mt-8 px-5 sm:px-10">
          ...
          <p className="text-gray-600 mt-2 leading-loose ">
            Please use the following One Time Password(OTP)
          </p>
          <div className="mt-4 flex items-center gap-x-4">
            <p className="flex h-10 w-10 items-center justify-center rounded-md border border-primary text-2xl font-medium text-primary">
              7
            </p>
            <p className="flex h-10 w-10 items-center justify-center rounded-md border border-primary text-2xl font-medium text-primary">
              8
          ...
          <button className="text-white bg-orange-600 hover:bg-orange-500 focus:ring-orange-300 mt-6 transform rounded-lg px-6 py-2 text-sm font-bold capitalize tracking-wider transition-colors duration-300 focus:outline-none focus:ring focus:ring-opacity-80">
            Verify email
          </button>
