    ...
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden">
      <div className="bg-white m-auto w-full rounded-md p-6 shadow-xl lg:max-w-xl">
        ...
        <div className="mt-4 flex gap-x-2">
          <button
            type="button"
            className="border-gray-600 focus:ring-violet-600 flex w-full items-center justify-center rounded-md border p-2 focus:ring-2 focus:ring-offset-1"
          >
            <svg
          ...
          <button className="border-gray-600 focus:ring-violet-600 flex w-full items-center justify-center rounded-md border p-2 focus:ring-2 focus:ring-offset-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="fill-current h-5 w-5"
